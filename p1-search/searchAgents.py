        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextx][nexty]:
                ...
                if nextP in self.corners:
                    ...
                    is_corners[idx] = True
                    is_corners = tuple(is_corners)
                nextState = (nextP, is_corners)
    ...
    def findPathToClosestDot(self, gameState):
        ...
        while not pq.isEmpty():
            ...
            for direction in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
                dx, dy = Actions.directionToVector(direction)
                nextx, nexty = int(x + dx), int(y + dy)
                if not walls[nextx][nexty] and (nextx, nexty) not in closed:
                    nextP = (nextx, nexty)
                    pq.push((nextP, path + [direction]), mazeDistance(nextP, nearest_Food, gameState))
        util.raiseNotDefined()
